...
window.PARTS = (() => {
  ...
  for (const [name, rar, note, chId] of [
    ...
    ['Enginos Berlina M', 'solid', 'the family weapon', 'berlina'],
    ['Enginos Bavaria GT', 'rare', 'silence, then 280', 'bavaria'],
    ['Enginos Piccola 02', 'common', 'small. angry. history.', 'piccola'],
    ['Houndsborough Duke', 'rare', 'a living room at speed', 'duke'],
    ['Houndsborough Chief', 'solid', 'the executive fortress', 'chief'],
    ['Heiligen Sturm', 'solid', 'the scoop breathes', 'sturm'],
    ['Heiligen Wald', 'common', 'carries dogs and firewood', 'wald'],
    ['Norte Stallion GT3', 'legendary', 'the rebrand. full send.', 'stallion'],
    ['Norte Potro', 'solid', 'the people’s stallion', 'potro'],
    ['Granada Garra', 'rare', 'the claw comes out', 'garra'],
    ['Granada Flecha', 'legendary', 'the arrow never lands', 'flecha'],
    ['Braewick Anvil', 'solid', 'a box that outruns you', 'anvil'],
    ['Braewick Torr', 'rare', 'highland monolith', 'torr'],
    ['Đồi Tám-Sáu', 'common', 'eight-six. you know.', 'tamsau'],
    ['Đồi Trâu', 'common', 'the buffalo forgives nothing', 'trau'],
    ['Đồi Ba Bánh', 'common', 'three wheels, zero fear', 'babanh'],
    ['Hilja Tähti', 'rare', 'silence at 300', 'tahti'],
    ['Hilja Lumi', 'solid', 'geometry refuses to age', 'lumi'],
    ['Hilja Siipi', 'legendary', 'the wing remembers', 'siipi'],
    ['Shopping Kart', 'rare', 'returned to the wrong lot', 'shopkart'],
