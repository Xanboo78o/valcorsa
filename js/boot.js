...
const SCRIPTS = ['js/config.js', 'js/palette.js', 'js/tracks.js', 'js/citydata.js', 'js/daynight.js',
                 'js/weather.js', 'js/postfx.js', 'js/carfactory.js', 'js/blockkit.js', 'js/pair.js', 'js/dress.js',
                 ...
                 'js/season.js', 'js/shell.js', 'js/hotlap.js', 'js/radio.js', 'js/flex.js', 'js/billboards.js'];
